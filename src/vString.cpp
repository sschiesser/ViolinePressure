...
bool vString::calibrate(CALIB_TYPE type, ADC_Module* module, range_t* range, thresh_t* thresh)
{
  ...
  switch (type)
  {
    ...
    case CALIB_TYPE::CALIB_RANGE: {
      ...
      send[0] = (uint8_t)HID_NOTIF::N_CR_DONE;
      send[1] = 8;
      send[2] = number;
    ...
    case CALIB_TYPE::CALIB_TOUCH: {
      ...
      send[0]  = (uint8_t)HID_NOTIF::N_CT_DONE;
      send[1]  = 10;
      send[2]  = number;
      ...
      send[9]  = retVal;
      send[10] = (uint8_t)MACHINE_STATE::S_CT_E;
